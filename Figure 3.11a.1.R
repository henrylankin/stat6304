...
#relativeFreqHome.1985 <- histogram(homeFrame$Year.1985, 
                                  # main = "Figure 3.11a.1: Homeowner Rates in 1985",
                                   #freq = T, xlab = "Homowner Rates", ylab = "Density", 
                                  # col = "white")
frequencyHistHome.1985 <- hist(homeFrame$Year.1985, plot = F)
relativeFreqHistHome.1985 <- frequencyHistHome.1985
relativeFreqHistHome.1985$counts <- relativeFreqHistHome.1985$counts/sum(relativeFreqHistHome.1985$counts)
plot(relativeFreqHistHome.1985, main = "Figure 3.11a.1: Homeowner Rates in 1985", 
     xlab = "Homeowner Rates", ylab = "Density", ylim = c(0,0.5))