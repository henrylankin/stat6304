...
frequencyHistHome.2002 <- hist(homeFrame$Year.2002, plot = F)
relativeFreqHistHome.2002 <- frequencyHistHome.2002
relativeFreqHistHome.2002$counts <- relativeFreqHistHome.2002$counts/sum(relativeFreqHistHome.2002$counts)
plot(relativeFreqHistHome.2002, main = "Figure 3.11a.3: Homeowner Rates in 2002", 
